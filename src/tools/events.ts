    ...
    "eb_event_attendees",
    {
      ...
      inputSchema: z.object({
        ...
        changed_since: z
          ...
          .optional()
          .describe(
            "ISO 8601 UTC timestamp — only attendees changed since then",
          ),
    ...
    async ({ event_id, status, changed_since, continuation, view }) => {
      ...
      return viewResponse(
        ...
        await client.request(
          "GET",
          `/events/${enc(event_id)}/attendees/${qs(params)}`,
        ),
      );
    },
  );
  ...
  server.registerTool(
    ...
    async ({ event_id, attendee_id, view }) =>
      viewResponse(
        ...
        await client.request(
          "GET",
          `/events/${enc(event_id)}/attendees/${enc(attendee_id)}/`,
        ),
      ),
  );
  ...
  server.registerTool(
    ...
    async ({ event_id, status, changed_since, continuation, view }) => {
      ...
      return viewResponse(
        ...
        await client.request(
          "GET",
          `/events/${enc(event_id)}/orders/${qs(params)}`,
        ),
      );
    },
  );
    ...
    "eb_event_questions",
    {
      ...
      inputSchema: z.object({
        ...
        canned: z
          ...
          .optional()
          .describe(
            "Fetch the standard question bank instead of the event's custom questions",
          ),
        view: viewArg(),
      }),
    },
