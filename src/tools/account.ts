  ...
  server.registerTool(
    ...
    async ({ continuation, view }) => {
      ...
      const data = await client.request(
        "GET",
        `/users/me/organizations/${qs(params)}`,
      );
      return viewResponse(view, data);
    },
  );
  ...
  server.registerTool(
    "eb_org_events",
    {
      ...
      inputSchema: z.object({
        ...
        org_id: z
          .string()
          .describe("Organization id (from eb_my_organizations)"),
        status: z
          .enum([
            "all",
            "live",
      ...
      async ({ org_id, continuation, view }) => {
        ...
        return viewResponse(
          ...
          await client.request(
            "GET",
            `/organizations/${enc(org_id)}/${noun}/${qs(params)}`,
          ),
        );
      },
    );
  ...
  server.registerTool(
    "eb_org_report",
    {
      ...
      inputSchema: z.object({
        ...
        start_date: z
          .string()
          .optional()
          .describe("ISO date lower bound (YYYY-MM-DD)"),
        end_date: z
          .string()
          .optional()
          .describe("ISO date upper bound (YYYY-MM-DD)"),
        event_status: z
          .enum(["live", "started", "ended", "completed", "canceled"])
          .optional(),
        group_by: z
          .string()
          .optional()
    ...
    async ({
      ...
      return viewResponse(
        ...
        await client.request(
          "GET",
          `/organizations/${enc(org_id)}/reports/${kind}/${qs(params)}`,
        ),
      );
    },
  );
