...
export function registerLookupTools(
  ...
  server.registerTool(
    ...
    async ({ order_id, expand, view }) => {
      ...
      return viewResponse(
        view,
        await client.request("GET", `/orders/${enc(order_id)}/${qs(params)}`),
      );
    },
  );
  ...
  server.registerTool(
    ...
    async ({ venue_id, view }) =>
      viewResponse(
        view,
        await client.request("GET", `/venues/${enc(venue_id)}/`),
      ),
  );
    ...
    async ({ venue_id, status, continuation, view }) => {
      ...
      return viewResponse(
        ...
        await client.request(
          "GET",
          `/venues/${enc(venue_id)}/events/${qs(params)}`,
        ),
      );
    },
  );
  ...
  server.registerTool(
    ...
    async ({ organizer_id, view }) =>
      viewResponse(
        view,
        await client.request("GET", `/organizers/${enc(organizer_id)}/`),
      ),
  );
  ...
  server.registerTool(
    ...
    async ({ organizer_id, status, order_by, continuation, view }) => {
      ...
      return viewResponse(
        ...
        await client.request(
          "GET",
          `/organizers/${enc(organizer_id)}/events/${qs(params)}`,
        ),
      );
    },
  );
  ...
  server.registerTool(
    "eb_series_events",
    {
      ...
      inputSchema: z.object({
        series_id: z
          .string()
          .describe("Numeric series id (from an event/search result)"),
        status: schemaEventStatus,
        continuation: schemaContinuation,
        view: viewArg(),
      }),
    ...
    async ({ series_id, status, continuation, view }) => {
      ...
      return viewResponse(
        ...
        await client.request(
          "GET",
          `/series/${enc(series_id)}/events/${qs(params)}`,
        ),
      );
    },
  );
  ...
  server.registerTool(
    ...
    async ({ user_id, view }) =>
      viewResponse(
        view,
        await client.request("GET", `/users/${enc(user_id)}/`),
      ),
  );
}
