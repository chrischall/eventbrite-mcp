...
export async function registerDiscoveryTools(
    ...
    "eb_search_events",
    {
      ...
      inputSchema: z.object({
        ...
        place_id: z
          ...
          .optional()
          .describe(
            "Eventbrite place id from eb_resolve_place (e.g. 85981333 = Charlotte NC)",
          ),
        date_keyword: z
          .enum([
            "today",
        ...
        category_id: z
          .string()
          .optional()
          .describe("Category id (eb_reference categories)"),
  ...
  const { registerBridgeHealthcheckTool } =
    await import("@chrischall/mcp-utils/fetchproxy");
